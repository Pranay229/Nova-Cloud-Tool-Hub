      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 relative">
            ...
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl shadow-2xl aspect-video flex items-center justify-center border border-gray-200">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Sparkles className="w-8 h-8 text-white" />
                </div>
                <p className="text-gray-400 font-medium">Professional Developer Tools</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group p-8 bg-white rounded-2xl border border-gray-200 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of developers using Nova tools every day.
          </p>
          <button
            onClick={onGetStarted}
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><a href="#" className="hover:text-gray-900">Hash Generator</a></li>
                <li><a href="#" className="hover:text-gray-900">UUID Generator</a></li>
                <li><a href="#" className="hover:text-gray-900">Password Generator</a></li>
                <li><a href="#" className="hover:text-gray-900">JSON Formatter</a></li>
              </ul>
            </div>
